...
const Footer = () => {
    return (
        <footer className='flex items-start justify-center flex-col w-full gap-20 bg-light-white lg:px-20 py-6 px-5'>
            ...
            <div className='flex items-center justify-between min-w-max w-full gap-3 flex-1 flex-col text-sm md:flex-row'>
